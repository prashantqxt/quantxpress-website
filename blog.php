  ...
  <section class="container py-6">
    <div class="row">
      <div class="col-12 col-md-4 col-lg-4 mb-5">
        <a href="blog_1.php">
          <div class="w-full bg-white border border-gray-200 rounded-3 overflow-hidden hover:shadow-lg transition duration-300">
            <img src="https://img.freepik.com/free-photo/business-concept-with-graphic-holography_23-2149160929.jpg" class="height-35 w-100 object-cover">
      ...
      <div class="col-12 col-md-4 col-lg-4 mb-5">
        <a href="blog_2.php">
          <div class="w-full bg-white border border-gray-200 rounded-3 overflow-hidden hover:shadow-lg transition duration-300">
            <img src="https://img.freepik.com/free-photo/beautiful-cryptocurrwncy-concept_23-2149250208.jpg" class="height-35 w-100 object-cover">
      ...
      <div class="col-12 col-md-4 col-lg-4 mb-5">
        <a href="blog_3.php">
          <div class="w-full bg-white border border-gray-200 rounded-3 overflow-hidden hover:shadow-lg transition duration-300">
            <img src="https://img.freepik.com/free-photo/beautiful-cryptocurrency-hologram-design_23-2149250210.jpg" class="height-35 w-100 object-cover">
      ...
      <div class="col-12 col-md-4 col-lg-4 mb-5">
        <a href="blog_4.php">
          <div class="w-full bg-white border border-gray-200 rounded-3 overflow-hidden hover:shadow-lg transition duration-300">
            <img src="https://img.freepik.com/free-photo/close-up-documents-with-colorful-graphs_1232-139.jpg" class="height-35 w-100 object-cover">
      ...
      <div class="col-12 col-md-4 col-lg-4 mb-5">
        <a href="blog_5.php">
          <div class="w-full bg-white border border-gray-200 rounded-3 overflow-hidden hover:shadow-lg transition duration-300">
            <img src="https://img.freepik.com/free-photo/african-american-man-working-with-forex-market-exchange-multi-monitors-workstation-analyzing-stock-funds-capital-banking-sales-buy-sell-profit-money-financial-growth_482257-43071.jpg" class="height-35 w-100 object-cover">
      ...
      <div class="col-12 col-md-4 col-lg-4 mb-5">
        <a href="blog_6.php">
          <div class="w-full bg-white border border-gray-200 rounded-3 overflow-hidden hover:shadow-lg transition duration-300">
            <img src="https://images.unsplash.com/photo-1672870153692-e34f6b3fa056?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="height-35 w-100 object-cover">
      ...
      <div class="col-12 col-md-4 col-lg-4 mb-5">
        <a href="blog_7.php">
          <div class="w-full bg-white border border-gray-200 rounded-3 overflow-hidden hover:shadow-lg transition duration-300">
            <img src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="height-35 w-100 object-cover">
      ...
      <div class="col-12 col-md-4 col-lg-4 mb-5">
        <a href="blog_8.php">
          <div class="w-full bg-white border border-gray-200 rounded-3 overflow-hidden hover:shadow-lg transition duration-300">
            <img src="https://images.unsplash.com/photo-1651341050677-24dba59ce0fd?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" class="height-35 w-100 object-cover">
