...
<div class="container-fluid page-top py-5" style="background: url('assets/img/blogs.png') no-repeat center center/cover;">
   <div class="row">
   ...
   <div class="container-fluid py-5">
      ...
      <div class="row">
         <div class="col-md-4 mb-4">
            <a href="blog_1.php">
                <div class="card h-100 border-0 hover-animation learn_more_hover border-0">
